          ...
          <div class="item-details-with-actions">
            ...
            <div class="item-actions">
              <div class="quantity-selector">
                ...
                <input type="text" class="quantity-input" :value="shoppingCartItems[1].quantity" aria-label="quantity" @blur="changeQuantity(shoppingCartItems[1].id, $event)">
          ...
          <div class="item-details-with-actions">
            ...
            <div class="item-actions">
              <div class="quantity-selector">
                ...
                <input type="text" class="quantity-input" :value="shoppingCartItems[2].quantity" aria-label="quantity" @blur="changeQuantity(shoppingCartItems[2].id, $event)">
          ...
          <div class="item-details-with-actions">
            ...
            <div class="item-actions">
              <div class="quantity-selector">
                ...
                <input type="text" class="quantity-input" :value="shoppingCartItems[3].quantity" aria-label="quantity" @blur="changeQuantity(shoppingCartItems[3].id, $event)">
          ...
          <div class="item-details-with-actions">
            ...
            <div class="item-actions">
              <div class="quantity-selector">
                ...
                <input type="text" class="quantity-input" :value="shoppingCartItems[4].quantity" aria-label="quantity" @blur="changeQuantity(shoppingCartItems[4].id, $event)">
